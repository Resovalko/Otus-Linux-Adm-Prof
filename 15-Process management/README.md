...
Скрипт [process_list_proc.sh](https://github.com/Resovalko/Otus-Linux-Adm-Prof/blob/main/15-Process management/process_list_proc.sh) выводит информацию о процесахх в системе, используя данные из директории **/proc**
