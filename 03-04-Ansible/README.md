...
```
На сервере **debian** установлен и настроен NGINX, доступен на порту **81**  
...
```
На сервере **vagrant_vm2** установлен и настроен NGINX, доступен на внутреннем порту **81**, на порту хост-машины **8081**  
```
